...
namespace UKFast.API.Client
{
    public class ClientConnection : IConnection
    {
        ...
        /// <summary>
        /// Constructs a new UKFast Client instance using provided API key
        /// </summary>
        /// <param name="apiKey">Application API key</param>
        public ClientConnection(string apiKey)
        {
            this.Client = GetDefaultClient();
            this.Credentials = new UKFastAPIKeyCredentials(apiKey);
        }

        /// <summary>
        /// Constructs a new UKFast Client instance using provided UKFastCredentials instance
        /// </summary>
        /// <param name="credentials">Instance of UKFastCredentials object</param>
        public ClientConnection(UKFastCredentials credentials)
        {
            this.Client = GetDefaultClient();
